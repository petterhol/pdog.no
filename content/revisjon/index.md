...
men det er selvfølgelig heller ingen forutsetning.
...
å fikse opp i det nå, enn å vente til det skjærer seg.
...
Buypass ID (med smartkort eller mobil) og Commfides.

BankID på mobil er på vei ut, men bruker du fremdeles dette kan det være lurt å sjekke at du
har gått over til BankID på kodebrikke eller BankID på app.

Du kan ha flere metoder aktivert for deg samtidig, og noen tjenester krever et høyere
sikkerhetsnivå, som gjør at noen av disse blir utilgjengelige.

Det er uansett fint å ha et bevisst forhold til dine innloggingsmetoder, og du burde derfor
sjekke at du har tilgang og at innstillingene dine er korrekt.

- For MinID, kan du sjekke aktivering, kodebrev og mer på
[Digitaliseringsdirektoratets
nettsider {{< ext >}}](https://eid.difi.no/index.php/nb/minid).

- Man kan logge inn på [BankIDs nettsider {{< ext >}}](https://bankid.no/privat/min-side)
...
sjekker du i nettbanken din.

- Buypass ID er utstedt av Buypass, og brukes nok primært i helsetjenesten, kommuner
og noen andre sektorer. Har du allikevel dette, kan du [logge inn og sjekke at du fremdeles har
tilgang {{< ext >}}](https://www.buypass.no/produkter/buypass-id-smartkort).

- Commfides er noe av det samme som Buypass, og kan utstedes privat, men mest sannsynligvis
mest i enkelte sektorer i næringslivet.
[Logg inn på Commfides nettsider {{< ext >}}](https://www.commfides.com/logg-inn/).

---

##### Kontakt- og reservasjonsregisteret: sjekk og oppdater opplyninger

Nå som du har funnet ut at innloggingen til ID-porten er i orden, kan du logge inn i det spennende
"Kontakt- og reservasjonsregisteret", som bare er statens måte å finne ut hvordan de når deg på.

Her kan du legge inn mobiltelefonnummer, e-postadresse, endre eller fjerne  din digitale postkasse,
reservere deg mot kommunikasjon på nett og endre målform på kommunikasjon med staten.

[Logg inn via Digitaliseringsdirektoratets
nettsider {{< ext >}}](https://brukerprofil.difi.no/minprofil/).
...
eksempel om donortilstand og kjernejournal, kan hjelpe deg seinere.

[Logg inn på helsenorge.no {{< ext >}}](https://helsenorge.no).
...
[Logg inn på nav.no {{< ext >}}](https://www.nav.no).
...
skatteopplysninger, ev. delegere eller fjerne delegering.

Man får også sitt skattekort i desember, så dette er en god anledning til å se over det
og gjøre endringer i henhold til planlagt økonomi i det neste året.

[Logg inn på skatteetaten.no {{< ext >}}](https://skatt.skatteetaten.no/web/minside/).
...
klistremerker til dette formålet.

Det finnes ikke noe sted man kan registrere sin reservasjon, og hvem som helst som har fysisk
tilgang til postkassen din, kan trosse ditt ønske. Husk at Posten ikke er de eneste som distribuerer
post og reklame i postkasser.

En av de enkleste måtene å merke en postkasse på, er å bestille det på
[Postens nettbutikk (skiltbutikken.posten.no) {{< ext >}}][posten-skilt], hvor man får
et stort poastkasseskilt med 8 tekstlinjer til under 200 kroner inkludert frakt.
...
[Logg inn via Brønnøysundregistrene
{{< ext >}}][brreg-telefonsalg]
...
greit å avslutte det?

[Registrer opplysningene på Samordnet registermelding {{< ext >}}][brreg-foretak].
...
[Bestill på politiet.no {{< ext >}}](https://www.politiet.no/tjenester/pass-og-id-kort/)
...
[Logg inn på Statens vegvesen sine nettsider {{< ext >}}](https://www.vegvesen.no/dinside/).
...
Sjekk nettsidene til kommunen din.
...
Sjekk nettsidene for ditt transportselskap.

---

##### Din kommunes bibliotek: Lånte titler, purringsaldo og digitale kilder

Det kan være lett å glemme en biblioteksbok. Sjekk om du, eller kanskje barna, har noen utestående
...
og bør du gjøre noen endringer?
...
også dine bankkort, og om det er behov for å gjøre endringer her.

---

##### Gjennomgang av bankkort

Ta både en titt på betalingskortene du har i nettbanken og i lommaboka. Har du riktig
...
Det kan hende du har penger andre steder enn tradisjonelle bankkontoer, for eksempel
...
gjøre noe med det, eller om det er bra slik det er.
...
domene, kan du til og med sette opp varsling på det domenet.

[Sjekk selv på haveibeenpwned.com {{< ext >}}](https://haveibeenpwned.com).
...
**Venner**: Kjenner du (fortsatt) alle du er venn med på Facebook? Tenk litt over hva du bruker
...
**Minnekonto**: Hva skjer med Facebook-kontoen når du dør? Husk å bestemme om du vil sette opp en
minnekonto, hvem som skal administrere den og legge opp årlig påminnesle.

**Personvernsinnstillinger**: Bruk litt tid på å gå gjennom og sjekke innstillingene som blant
...
er venn med på Facebook.

[Innstillingene finner du på Facebook-profilen din {{< ext >}}](https://www.facebook.com/settings).
...
ditt stemmer overens med virkeligheten.

Årsaken er nemlig at mobilnummeret ditt er en av de viktigste brikkene av din digitale
...
[posten-skilt]: vg.no
[brreg-telefonsalg]: https://www.altinn.no/skjemaoversikt/bronnoysundregistrene/reservasjon-mot-telefonsalg-og-adressert-reklame/
